...
## Stage78-1 SimNow 虚拟盘 SOP

1. 当用户要求运行或解释第78-1的每日影子盘、SimNow虚拟盘、CTP/SimNow通路、Phase B委托草案/提交前闸门、AI池月更、`review`风险层级、每日对账或“今天/今晚/下个交易时段是否需要交易”时，先读取并遵循 `skills/stage78-simnow-shadow-sop/SKILL.md`。
