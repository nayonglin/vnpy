...
def main() -> None:
    engine, _, statistics = run_backtest(
        file_prefix="qmt_range_reversion_core4_directed_product_signal_back_adjusted_v7",
        chart_title="QMT Range Reversion Core4 Directed Product Signal Back Adjusted V7 Backtest",
        strategy_tag="range_reversion_core4_directed_product_signal_back_adjusted_v7",
        setting_overrides={
