...
def main() -> None:
    engine, _, statistics = run_backtest(
        file_prefix="qmt_range_reversion_core4_directed_product_signal_back_adjusted_v9_short_soft_floor",
        chart_title="QMT Range Reversion Core4 Directed Product Signal Back Adjusted V9 Short Soft Floor Backtest",
        strategy_tag="range_reversion_core4_directed_product_signal_back_adjusted_v9_short_soft_floor",
        setting_overrides={
