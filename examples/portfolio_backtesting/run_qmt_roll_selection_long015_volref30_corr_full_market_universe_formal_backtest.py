...
EXPERIMENT_TAG: str = "qmt_roll_selection_long015_volref30_corr_full_market_universe_formal"
...
EXPERIMENTS: tuple[dict[str, Any], ...] = (
    {
        "experiment_name": "full_market_floor35",
        "file_prefix": "qmt_roll_selection_long015_volref30_corr_full_market_floor35_formal",
        "chart_title": "QMT Roll VolRef30 Corr Floor35 Full-Market Universe Formal",
        "strategy_overrides": {
            **CORR20_06_08_FLOOR35_OVERRIDES,
...
def run_experiments() -> pd.DataFrame:
    ...
    for experiment in EXPERIMENTS:
        ...
        print(f"[full-market-universe-formal] running {experiment_name}")
...
def build_payload(summary_df: pd.DataFrame) -> dict[str, Any]:
    baseline = {
        "experiment_name": "stage53_18_product_floor35",
    ...
    if not summary_df.empty:
        ...
        payload["comparison_vs_stage53_18_product_floor35"] = {
...
def main() -> None:
    if not UNIVERSE_PATH.exists():
        raise FileNotFoundError(f"missing full-market universe csv: {UNIVERSE_PATH}")
    ...
    print(f"[full-market-universe-formal] summary csv: {SUMMARY_CSV_PATH}")
    print(f"[full-market-universe-formal] summary json: {SUMMARY_JSON_PATH}")
