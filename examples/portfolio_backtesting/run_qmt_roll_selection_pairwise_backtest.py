...
EXPERIMENT_TAG: str = "qmt_roll_selection_pairwise_v2_backtest"
...
EXPERIMENTS: tuple[dict[str, Any], ...] = (
    {
        ...
        "file_prefix": "qmt_roll_selection_baseline",
        "chart_title": "QMT Roll Selection Baseline",
        "strategy_overrides": {},
    },
    {
        "experiment_name": "selection_pairwise_v2",
        "file_prefix": "qmt_roll_selection_pairwise_v2",
        "chart_title": "QMT Roll Selection Pairwise v2",
        "strategy_overrides": {
    ...
    {
        "experiment_name": "selection_pairwise_v2_catastrophic_veto_v1",
        "file_prefix": "qmt_roll_selection_pairwise_v2_catastrophic_veto_v1",
        "chart_title": "QMT Roll Selection Pairwise v2 Catastrophic Veto v1",
        "strategy_overrides": {
            "enable_selection_pairwise_v2": True,
            "enable_selection_pairwise_v2_catastrophic_veto": True,
...
def run_experiments() -> pd.DataFrame:
    ...
    for experiment in EXPERIMENTS:
        ...
        print(f"[selection-pairwise-backtest] running {experiment_name}")
...
def build_summary_payload(summary_df: pd.DataFrame) -> dict[str, Any]:
    ...
    for experiment_name in ["selection_pairwise_v2", "selection_pairwise_v2_catastrophic_veto_v1"]:
    ...
    payload["comparison_vs_baseline"] = comparisons
    return payload
...
def main() -> None:
    ...
    print(f"[selection-pairwise-backtest] summary csv: {SUMMARY_CSV_PATH}")
    print(f"[selection-pairwise-backtest] summary json: {SUMMARY_JSON_PATH}")
