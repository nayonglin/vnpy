...
EXPERIMENT_TAG: str = "qmt_roll_selection_pairwise_long015_backtest"
...
EXPERIMENTS: tuple[dict[str, Any], ...] = (
    {
        ...
        "file_prefix": "qmt_roll_selection_baseline_long015_compare",
        "chart_title": "QMT Roll Selection Baseline Long015 Compare",
        "strategy_overrides": {},
    },
    {
        "experiment_name": "selection_pairwise_v2",
        "file_prefix": "qmt_roll_selection_pairwise_v2_long015_compare",
        "chart_title": "QMT Roll Selection Pairwise v2 Long015 Compare",
        "strategy_overrides": {
    ...
    },
    {
        ...
        "file_prefix": "qmt_roll_selection_pairwise_v2_volume_tilt_long015_formal",
        "chart_title": "QMT Roll Selection Pairwise v2 Volume Tilt Long015 Formal",
        "strategy_overrides": {
            "enable_selection_pairwise_v2": True,
            "enable_selection_pairwise_v2_catastrophic_veto": False,
...
def run_experiments() -> pd.DataFrame:
    ...
    for experiment in EXPERIMENTS:
        ...
        print(f"[selection-pairwise-long015-backtest] running {experiment_name}")
...
def main() -> None:
    ...
    print(f"[selection-pairwise-long015-backtest] summary csv: {SUMMARY_CSV_PATH}")
    print(f"[selection-pairwise-long015-backtest] summary json: {SUMMARY_JSON_PATH}")
