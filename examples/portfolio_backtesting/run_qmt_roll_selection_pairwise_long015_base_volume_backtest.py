...
EXPERIMENT_TAG: str = "qmt_roll_selection_pairwise_long015_base_volume_backtest"
...
EXPERIMENTS: tuple[dict[str, Any], ...] = (
    {
        ...
        "file_prefix": "qmt_roll_selection_pairwise_v2_long015_base_volume_compare",
        "chart_title": "QMT Roll Selection Pairwise v2 Long015 Base Volume Compare",
        "strategy_overrides": BASE_PAIRWISE,
    },
    {
        "experiment_name": "selection_pairwise_v2_volume_tilt_long015",
        "file_prefix": "qmt_roll_selection_pairwise_v2_volume_tilt_long015_base_volume_compare",
        "chart_title": "QMT Roll Selection Pairwise v2 Volume Tilt Long015 Base Volume Compare",
        "strategy_overrides": BASE_LONG015,
    },
    {
        "experiment_name": "selection_pairwise_v2_volume_tilt_long015_volref20",
        "file_prefix": "qmt_roll_selection_pairwise_v2_volume_tilt_long015_volref20",
        "chart_title": "QMT Roll Selection Pairwise v2 Volume Tilt Long015 VolRef20",
        "strategy_overrides": {
            **BASE_LONG015,
            "selection_pairwise_volume_tilt_long_base_volume_reference": 20.0,
        },
    },
    {
        "experiment_name": "selection_pairwise_v2_volume_tilt_long015_volref30",
        "file_prefix": "qmt_roll_selection_pairwise_v2_volume_tilt_long015_volref30",
        "chart_title": "QMT Roll Selection Pairwise v2 Volume Tilt Long015 VolRef30",
        "strategy_overrides": {
            **BASE_LONG015,
...
def run_experiments() -> pd.DataFrame:
    ...
    for experiment in EXPERIMENTS:
        ...
        print(f"[selection-pairwise-long015-base-volume] running {experiment_name}")
...
def main() -> None:
    ...
    print(f"[selection-pairwise-long015-base-volume] summary csv: {SUMMARY_CSV_PATH}")
    print(f"[selection-pairwise-long015-base-volume] summary json: {SUMMARY_JSON_PATH}")
