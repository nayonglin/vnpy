...
EXPERIMENT_TAG: str = "qmt_roll_selection_pairwise_long015_conditional_backtest"
...
EXPERIMENTS: tuple[dict[str, Any], ...] = (
    {
        ...
        "file_prefix": "qmt_roll_selection_pairwise_v2_long015_conditional_compare",
        "chart_title": "QMT Roll Selection Pairwise v2 Long015 Conditional Compare",
        "strategy_overrides": BASE_PAIRWISE,
    },
    {
        "experiment_name": "selection_pairwise_v2_volume_tilt_long015",
        "file_prefix": "qmt_roll_selection_pairwise_v2_volume_tilt_long015_conditional_compare",
        "chart_title": "QMT Roll Selection Pairwise v2 Volume Tilt Long015 Conditional Compare",
        "strategy_overrides": LONG015_BASE,
    },
    {
        "experiment_name": "selection_pairwise_v2_volume_tilt_long015_gap010",
        "file_prefix": "qmt_roll_selection_pairwise_v2_volume_tilt_long015_gap010",
        "chart_title": "QMT Roll Selection Pairwise v2 Volume Tilt Long015 Gap010",
        "strategy_overrides": {
            **LONG015_BASE,
            "selection_pairwise_volume_tilt_min_score_gap": 0.10,
        },
    },
    {
        "experiment_name": "selection_pairwise_v2_volume_tilt_long015_gap020",
        "file_prefix": "qmt_roll_selection_pairwise_v2_volume_tilt_long015_gap020",
        "chart_title": "QMT Roll Selection Pairwise v2 Volume Tilt Long015 Gap020",
        "strategy_overrides": {
            **LONG015_BASE,
            "selection_pairwise_volume_tilt_min_score_gap": 0.20,
        },
    },
)
...
def run_experiments() -> pd.DataFrame:
    ...
    for experiment in EXPERIMENTS:
        ...
        print(f"[selection-pairwise-long015-conditional] running {experiment_name}")
...
def build_summary_payload(summary_df: pd.DataFrame) -> dict[str, Any]:
    ...
    for experiment_name in [
        ...
        experiment_df = summary_df[summary_df["experiment_name"] == experiment_name]
...
def main() -> None:
    ...
    print(f"[selection-pairwise-long015-conditional] summary csv: {SUMMARY_CSV_PATH}")
    print(f"[selection-pairwise-long015-conditional] summary json: {SUMMARY_JSON_PATH}")
