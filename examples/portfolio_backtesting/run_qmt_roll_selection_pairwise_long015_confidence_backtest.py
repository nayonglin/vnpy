...
EXPERIMENT_TAG: str = "qmt_roll_selection_pairwise_long015_confidence_backtest"
...
EXPERIMENTS: tuple[dict[str, Any], ...] = (
    {
        ...
        "file_prefix": "qmt_roll_selection_pairwise_v2_long015_confidence_compare",
        "chart_title": "QMT Roll Selection Pairwise v2 Long015 Confidence Compare",
        "strategy_overrides": BASE_PAIRWISE,
    },
    {
        "experiment_name": "selection_pairwise_v2_volume_tilt_long015",
        "file_prefix": "qmt_roll_selection_pairwise_v2_volume_tilt_long015_confidence_compare",
        "chart_title": "QMT Roll Selection Pairwise v2 Volume Tilt Long015 Confidence Compare",
        "strategy_overrides": BASE_LONG015,
    },
    {
        "experiment_name": "selection_pairwise_v2_volume_tilt_long015_gapref025",
        "file_prefix": "qmt_roll_selection_pairwise_v2_volume_tilt_long015_gapref025",
        "chart_title": "QMT Roll Selection Pairwise v2 Volume Tilt Long015 GapRef025",
        "strategy_overrides": {
            **BASE_LONG015,
            "selection_pairwise_volume_tilt_long_score_gap_reference": 0.25,
        },
    },
    {
        "experiment_name": "selection_pairwise_v2_volume_tilt_long015_gapref050",
        "file_prefix": "qmt_roll_selection_pairwise_v2_volume_tilt_long015_gapref050",
        "chart_title": "QMT Roll Selection Pairwise v2 Volume Tilt Long015 GapRef050",
        "strategy_overrides": {
            **BASE_LONG015,
            "selection_pairwise_volume_tilt_long_score_gap_reference": 0.50,
        },
    },
)
...
def run_experiments() -> pd.DataFrame:
    ...
    for experiment in EXPERIMENTS:
        ...
        print(f"[selection-pairwise-long015-confidence] running {experiment_name}")
...
def main() -> None:
    ...
    print(f"[selection-pairwise-long015-confidence] summary csv: {SUMMARY_CSV_PATH}")
    print(f"[selection-pairwise-long015-confidence] summary json: {SUMMARY_JSON_PATH}")
