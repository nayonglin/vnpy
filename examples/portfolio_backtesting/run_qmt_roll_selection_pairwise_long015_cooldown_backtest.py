...
EXPERIMENT_TAG: str = "qmt_roll_selection_pairwise_long015_cooldown_backtest"
...
EXPERIMENTS: tuple[dict[str, Any], ...] = (
    {
        ...
        "file_prefix": "qmt_roll_selection_pairwise_v2_long015_cooldown_compare",
        "chart_title": "QMT Roll Selection Pairwise v2 Long015 Cooldown Compare",
        "strategy_overrides": BASE_PAIRWISE,
    },
    {
        "experiment_name": "selection_pairwise_v2_volume_tilt_long015",
        "file_prefix": "qmt_roll_selection_pairwise_v2_volume_tilt_long015_cooldown_compare",
        "chart_title": "QMT Roll Selection Pairwise v2 Volume Tilt Long015 Cooldown Compare",
        "strategy_overrides": LONG015_BASE,
    },
    {
        "experiment_name": "selection_pairwise_v2_volume_tilt_long015_cooldown3",
        "file_prefix": "qmt_roll_selection_pairwise_v2_volume_tilt_long015_cooldown3",
        "chart_title": "QMT Roll Selection Pairwise v2 Volume Tilt Long015 Cooldown3",
        "strategy_overrides": {
            **LONG015_BASE,
            "selection_pairwise_volume_tilt_cooldown_days": 3,
        },
    },
)
...
def run_experiments() -> pd.DataFrame:
    ...
    for experiment in EXPERIMENTS:
        ...
        print(f"[selection-pairwise-long015-cooldown] running {experiment_name}")
...
def main() -> None:
    ...
    print(f"[selection-pairwise-long015-cooldown] summary csv: {SUMMARY_CSV_PATH}")
    print(f"[selection-pairwise-long015-cooldown] summary json: {SUMMARY_JSON_PATH}")
