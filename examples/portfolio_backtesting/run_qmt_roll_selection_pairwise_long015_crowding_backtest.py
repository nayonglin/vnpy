...
EXPERIMENT_TAG: str = "qmt_roll_selection_pairwise_long015_crowding_backtest"
...
EXPERIMENTS: tuple[dict[str, Any], ...] = (
    {
        ...
        "file_prefix": "qmt_roll_selection_pairwise_v2_long015_crowding_compare",
        "chart_title": "QMT Roll Selection Pairwise v2 Long015 Crowding Compare",
        "strategy_overrides": BASE_PAIRWISE,
    },
    {
        "experiment_name": "selection_pairwise_v2_volume_tilt_long015",
        "file_prefix": "qmt_roll_selection_pairwise_v2_volume_tilt_long015_crowding_compare",
        "chart_title": "QMT Roll Selection Pairwise v2 Volume Tilt Long015 Crowding Compare",
        "strategy_overrides": BASE_LONG015,
    },
    {
        "experiment_name": "selection_pairwise_v2_volume_tilt_long015_crowd0375",
        "file_prefix": "qmt_roll_selection_pairwise_v2_volume_tilt_long015_crowd0375",
        "chart_title": "QMT Roll Selection Pairwise v2 Volume Tilt Long015 Crowd0375",
        "strategy_overrides": {
            **BASE_LONG015,
            "selection_pairwise_volume_tilt_long_active_ratio_full_strength_max": 0.375,
        },
    },
    {
        "experiment_name": "selection_pairwise_v2_volume_tilt_long015_crowd025",
        "file_prefix": "qmt_roll_selection_pairwise_v2_volume_tilt_long015_crowd025",
        "chart_title": "QMT Roll Selection Pairwise v2 Volume Tilt Long015 Crowd025",
        "strategy_overrides": {
            **BASE_LONG015,
            "selection_pairwise_volume_tilt_long_active_ratio_full_strength_max": 0.25,
        },
    },
)
...
def run_experiments() -> pd.DataFrame:
    ...
    for experiment in EXPERIMENTS:
        ...
        print(f"[selection-pairwise-long015-crowding] running {experiment_name}")
...
def main() -> None:
    ...
    print(f"[selection-pairwise-long015-crowding] summary csv: {SUMMARY_CSV_PATH}")
    print(f"[selection-pairwise-long015-crowding] summary json: {SUMMARY_JSON_PATH}")
