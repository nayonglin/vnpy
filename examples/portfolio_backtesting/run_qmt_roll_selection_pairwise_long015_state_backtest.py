...
EXPERIMENT_TAG: str = "qmt_roll_selection_pairwise_long015_state_backtest"
...
EXPERIMENTS: tuple[dict[str, Any], ...] = (
    {
        ...
        "file_prefix": "qmt_roll_selection_pairwise_v2_long015_state_compare",
        "chart_title": "QMT Roll Selection Pairwise v2 Long015 State Compare",
        "strategy_overrides": BASE_PAIRWISE,
    },
    {
        "experiment_name": "selection_pairwise_v2_volume_tilt_long015",
        "file_prefix": "qmt_roll_selection_pairwise_v2_volume_tilt_long015_state_compare",
        "chart_title": "QMT Roll Selection Pairwise v2 Volume Tilt Long015 State Compare",
        "strategy_overrides": BASE_LONG015,
    },
    {
        "experiment_name": "selection_pairwise_v2_volume_tilt_long015_ret20cap075",
        "file_prefix": "qmt_roll_selection_pairwise_v2_volume_tilt_long015_ret20cap075",
        "chart_title": "QMT Roll Selection Pairwise v2 Volume Tilt Long015 Ret20Cap075",
        "strategy_overrides": {
            **BASE_LONG015,
            "selection_pairwise_volume_tilt_long_max_avg_ret20_zscore": 0.75,
        },
    },
    {
        "experiment_name": "selection_pairwise_v2_volume_tilt_long015_rsi68",
        "file_prefix": "qmt_roll_selection_pairwise_v2_volume_tilt_long015_rsi68",
        "chart_title": "QMT Roll Selection Pairwise v2 Volume Tilt Long015 Rsi68",
        "strategy_overrides": {
            **BASE_LONG015,
            "selection_pairwise_volume_tilt_long_max_avg_rsi": 68.0,
        },
    },
    {
        "experiment_name": "selection_pairwise_v2_volume_tilt_long015_ret20cap075_rsi68",
        "file_prefix": "qmt_roll_selection_pairwise_v2_volume_tilt_long015_ret20cap075_rsi68",
        "chart_title": "QMT Roll Selection Pairwise v2 Volume Tilt Long015 Ret20Cap075 Rsi68",
        "strategy_overrides": {
            **BASE_LONG015,
            "selection_pairwise_volume_tilt_long_max_avg_ret20_zscore": 0.75,
            "selection_pairwise_volume_tilt_long_max_avg_rsi": 68.0,
...
def run_experiments() -> pd.DataFrame:
    ...
    for experiment in EXPERIMENTS:
        ...
        print(f"[selection-pairwise-long015-state] running {experiment_name}")
...
def build_summary_payload(summary_df: pd.DataFrame) -> dict[str, Any]:
    ...
    pairwise_df = summary_df[summary_df["experiment_name"] == "selection_pairwise_v2"]
    if not pairwise_df.empty:
        pairwise_row = pairwise_df.iloc[0]
        payload["comparison_vs_pairwise_v2"] = [
            build_comparison_row(pairwise_row, row)
            for _, row in summary_df.iterrows()
            if str(row["experiment_name"]) != "selection_pairwise_v2"
        ]
...
def main() -> None:
    ...
    print(f"[selection-pairwise-long015-state] summary csv: {SUMMARY_CSV_PATH}")
    print(f"[selection-pairwise-long015-state] summary json: {SUMMARY_JSON_PATH}")
