...
EXPERIMENT_TAG: str = "qmt_roll_selection_pairwise_long015_volref30_active_positions_backtest"
...
EXPERIMENTS: tuple[dict[str, Any], ...] = (
    {
        ...
        "file_prefix": "qmt_roll_selection_pairwise_v2_long015_volref30_active_positions_compare",
        "chart_title": "QMT Roll Selection Pairwise v2 Long015 VolRef30 Active Positions Compare",
        "strategy_overrides": BASE_PAIRWISE,
    },
    {
        "experiment_name": "selection_pairwise_v2_volume_tilt_long015_volref30",
        "file_prefix": "qmt_roll_selection_pairwise_v2_volume_tilt_long015_volref30_active_positions_compare",
        "chart_title": "QMT Roll Selection Pairwise v2 Volume Tilt Long015 VolRef30 Active Positions Compare",
        "strategy_overrides": BASE_LONG015_VOLREF30,
    },
    {
        "experiment_name": "selection_pairwise_v2_volume_tilt_long015_volref30_apref2",
        "file_prefix": "qmt_roll_selection_pairwise_v2_volume_tilt_long015_volref30_apref2",
        "chart_title": "QMT Roll Selection Pairwise v2 Volume Tilt Long015 VolRef30 APRef2",
        "strategy_overrides": {
    ...
    },
    {
        ...
        "file_prefix": "qmt_roll_selection_pairwise_v2_volume_tilt_long015_volref30_apref25",
        "chart_title": "QMT Roll Selection Pairwise v2 Volume Tilt Long015 VolRef30 APRef25",
        "strategy_overrides": {
            **BASE_LONG015_VOLREF30,
    ...
    },
    {
        ...
        "file_prefix": "qmt_roll_selection_pairwise_v2_volume_tilt_long015_volref30_apref3",
        "chart_title": "QMT Roll Selection Pairwise v2 Volume Tilt Long015 VolRef30 APRef3",
        "strategy_overrides": {
            **BASE_LONG015_VOLREF30,
...
def run_experiments() -> pd.DataFrame:
    ...
    for experiment in EXPERIMENTS:
        ...
        print(f"[selection-pairwise-long015-volref30-active-positions] running {experiment_name}")
...
def main() -> None:
    ...
    print(f"[selection-pairwise-long015-volref30-active-positions] summary csv: {SUMMARY_CSV_PATH}")
    print(f"[selection-pairwise-long015-volref30-active-positions] summary json: {SUMMARY_JSON_PATH}")
