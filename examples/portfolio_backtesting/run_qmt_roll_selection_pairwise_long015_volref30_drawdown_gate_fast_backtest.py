...
EXPERIMENT_TAG: str = "qmt_roll_selection_pairwise_long015_volref30_drawdown_gate_fast"
    ...
    *,
    ...
    return {
        **VOLREF30_OVERRIDES,
        ...
        "portfolio_drawdown_gate_weight_floor": weight_floor,
    }
...
EXPERIMENTS: tuple[dict[str, Any], ...] = (
    ...
    {
        "experiment_name": "volref30_ddgate_10_25_floor50",
        "strategy_overrides": drawdown_gate_overrides(
            start_pct=0.10,
            full_pct=0.25,
            weight_floor=0.50,
        ),
    ...
    {
        "experiment_name": "volref30_ddgate_10_25_floor35",
        "strategy_overrides": drawdown_gate_overrides(
            start_pct=0.10,
            full_pct=0.25,
            weight_floor=0.35,
    ...
    {
        "experiment_name": "volref30_ddgate_15_30_floor50",
        "strategy_overrides": drawdown_gate_overrides(
            start_pct=0.15,
            full_pct=0.30,
            weight_floor=0.50,
...
def run_experiments() -> pd.DataFrame:
    ...
    for experiment in EXPERIMENTS:
        ...
        print(f"[volref30-drawdown-gate-fast] running {experiment_name}")
...
def build_comparison_payload(summary_df: pd.DataFrame) -> dict[str, Any]:
    ...
    payload["comparison_vs_volref30_current"] = comparison_rows
    return payload
...
def main() -> None:
    ...
    print(f"[volref30-drawdown-gate-fast] summary csv: {SUMMARY_CSV_PATH}")
    print(f"[volref30-drawdown-gate-fast] summary json: {SUMMARY_JSON_PATH}")
