...
EXPERIMENT_TAG: str = "qmt_roll_selection_pairwise_long015_volref30_formal_backtest"
...
LONG015_VOLREF30_OVERRIDES: dict[str, Any] = {
    **LONG015_OVERRIDES,
...
EXPERIMENTS: tuple[dict[str, Any], ...] = (
    {
        ...
        "file_prefix": "qmt_roll_selection_long015_volref30_formal_baseline",
        "chart_title": "QMT Roll Selection Long015 VolRef30 Formal Baseline",
        "strategy_overrides": {},
    },
    {
        "experiment_name": "selection_pairwise_v2",
        "file_prefix": "qmt_roll_selection_long015_volref30_formal_pairwise_v2",
        "chart_title": "QMT Roll Selection Long015 VolRef30 Formal Pairwise v2",
        "strategy_overrides": PAIRWISE_OVERRIDES,
    },
    {
        "experiment_name": "selection_pairwise_v2_volume_tilt_long015",
        "file_prefix": "qmt_roll_selection_long015_volref30_formal_long015",
        "chart_title": "QMT Roll Selection Long015 VolRef30 Formal Long015",
        "strategy_overrides": LONG015_OVERRIDES,
    },
    {
        "experiment_name": "selection_pairwise_v2_volume_tilt_long015_volref30",
        "file_prefix": "qmt_roll_selection_long015_volref30_formal_volref30",
        "chart_title": "QMT Roll Selection Long015 VolRef30 Formal VolRef30",
        "strategy_overrides": LONG015_VOLREF30_OVERRIDES,
    },
)
...
def run_experiments() -> pd.DataFrame:
    ...
    for experiment in EXPERIMENTS:
        ...
        print(f"[selection-pairwise-long015-volref30-formal] running {experiment_name}")
...
def build_summary_payload(summary_df: pd.DataFrame) -> dict[str, Any]:
    ...
    baseline_df = summary_df[summary_df["experiment_name"] == "ungated_baseline"]
    if not baseline_df.empty:
        baseline_row = baseline_df.iloc[0]
        payload["comparison_vs_baseline"] = [
            build_comparison_row(baseline_row, row)
            for _, row in summary_df.iterrows()
            if str(row["experiment_name"]) != "ungated_baseline"
        ]
...
def main() -> None:
    ...
    print(f"[selection-pairwise-long015-volref30-formal] summary csv: {SUMMARY_CSV_PATH}")
    print(f"[selection-pairwise-long015-volref30-formal] summary json: {SUMMARY_JSON_PATH}")
