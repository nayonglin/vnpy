...
EXPERIMENT_TAG: str = "qmt_roll_selection_pairwise_long015_volref30_range_fast_backtest"
...
EXPERIMENTS: tuple[dict[str, Any], ...] = (
    {
        "experiment_name": "selection_pairwise_v2_volume_tilt_long015_volref30_range075",
        "file_prefix": "qmt_roll_selection_pairwise_v2_volume_tilt_long015_volref30_range075_fast",
        "chart_title": "QMT Roll Selection Pairwise v2 Volume Tilt Long015 VolRef30 Range075 Fast",
        "strategy_overrides": {
            **BASE_LONG015_VOLREF30,
            "selection_pairwise_volume_tilt_long_max_range_zscore_reference": 0.75,
        },
    },
    {
        "experiment_name": "selection_pairwise_v2_volume_tilt_long015_volref30_range100",
        "file_prefix": "qmt_roll_selection_pairwise_v2_volume_tilt_long015_volref30_range100_fast",
        "chart_title": "QMT Roll Selection Pairwise v2 Volume Tilt Long015 VolRef30 Range100 Fast",
        "strategy_overrides": {
            **BASE_LONG015_VOLREF30,
            "selection_pairwise_volume_tilt_long_max_range_zscore_reference": 1.0,
        },
    },
    {
        "experiment_name": "selection_pairwise_v2_volume_tilt_long015_volref30_range150",
        "file_prefix": "qmt_roll_selection_pairwise_v2_volume_tilt_long015_volref30_range150_fast",
        "chart_title": "QMT Roll Selection Pairwise v2 Volume Tilt Long015 VolRef30 Range150 Fast",
        "strategy_overrides": {
            **BASE_LONG015_VOLREF30,
            "selection_pairwise_volume_tilt_long_max_range_zscore_reference": 1.5,
        },
    },
)
...
def run_experiments() -> pd.DataFrame:
    ...
    for experiment in EXPERIMENTS:
        ...
        print(f"[selection-pairwise-long015-volref30-range-fast] running {experiment_name}")
...
def main() -> None:
    ...
    print(f"[selection-pairwise-long015-volref30-range-fast] summary csv: {SUMMARY_CSV_PATH}")
    print(f"[selection-pairwise-long015-volref30-range-fast] summary json: {SUMMARY_JSON_PATH}")
