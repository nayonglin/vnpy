...
EXPERIMENT_TAG: str = "qmt_roll_selection_pairwise_long015_volref30_streak_risk_fast"
...
def streak_overrides(streak_risk_multipliers: str) -> dict[str, Any]:
    return {
        **VOLREF30_OVERRIDES,
        "streak_risk_multipliers": streak_risk_multipliers,
    }
...
EXPERIMENTS: tuple[dict[str, Any], ...] = (
    ...
    {
        "experiment_name": "volref30_streak_soft_after2",
        "strategy_overrides": streak_overrides("1.0,1.0,0.5,0.1"),
    },
    {
        "experiment_name": "volref30_streak_linear",
        "strategy_overrides": streak_overrides("1.0,0.7,0.3,0.1"),
    },
    {
        "experiment_name": "volref30_streak_cut_after2",
        "strategy_overrides": streak_overrides("1.0,1.0,0.0,0.0"),
    },
)
...
def run_experiments() -> pd.DataFrame:
    ...
    for experiment in EXPERIMENTS:
        ...
        print(f"[volref30-streak-risk-fast] running {experiment_name}")
...
def main() -> None:
    ...
    print(f"[volref30-streak-risk-fast] summary csv: {SUMMARY_CSV_PATH}")
    print(f"[volref30-streak-risk-fast] summary json: {SUMMARY_JSON_PATH}")
