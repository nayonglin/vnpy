...
EXPERIMENT_TAG: str = "qmt_roll_selection_pairwise_long_tilt_stability_backtest"
...
def build_long_tilt_overrides(long_strength: float) -> dict[str, Any]:
    return {
        **BASE_PAIRWISE,
        "enable_selection_pairwise_v2_volume_tilt": True,
        "selection_pairwise_volume_tilt_strength": 0.0,
        "selection_pairwise_volume_tilt_long_strength": long_strength,
...
EXPERIMENTS: tuple[dict[str, Any], ...] = (
    {
        ...
        "file_prefix": "qmt_roll_selection_pairwise_v2_long_tilt_stability",
        "chart_title": "QMT Roll Selection Pairwise v2 Long Tilt Stability",
        "strategy_overrides": BASE_PAIRWISE,
    },
    {
        "experiment_name": "selection_pairwise_v2_volume_tilt_long010",
        "file_prefix": "qmt_roll_selection_pairwise_v2_volume_tilt_long010_stability",
        "chart_title": "QMT Roll Selection Pairwise v2 Volume Tilt Long010 Stability",
        "strategy_overrides": build_long_tilt_overrides(0.10),
    },
    {
        "experiment_name": "selection_pairwise_v2_volume_tilt_long015",
        "file_prefix": "qmt_roll_selection_pairwise_v2_volume_tilt_long015_stability",
        "chart_title": "QMT Roll Selection Pairwise v2 Volume Tilt Long015 Stability",
        "strategy_overrides": build_long_tilt_overrides(0.15),
    },
    {
        "experiment_name": "selection_pairwise_v2_volume_tilt_long020",
        "file_prefix": "qmt_roll_selection_pairwise_v2_volume_tilt_long020_stability",
        "chart_title": "QMT Roll Selection Pairwise v2 Volume Tilt Long020 Stability",
        "strategy_overrides": build_long_tilt_overrides(0.20),
    },
)
...
def run_experiments() -> pd.DataFrame:
    ...
    for experiment in EXPERIMENTS:
        ...
        print(f"[selection-pairwise-long-tilt-stability] running {experiment_name}")
...
def main() -> None:
    ...
    print(f"[selection-pairwise-long-tilt-stability] summary csv: {SUMMARY_CSV_PATH}")
    print(f"[selection-pairwise-long-tilt-stability] summary json: {SUMMARY_JSON_PATH}")
