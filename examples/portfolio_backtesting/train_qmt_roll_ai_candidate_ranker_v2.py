...
def main() -> None:
    ...
    print(f"[ai-candidate-ranker-v2] model: {MODEL_OUTPUT_PATH}")
    print(f"[ai-candidate-ranker-v2] summary: {SUMMARY_OUTPUT_PATH}")
    print(f"[ai-candidate-ranker-v2] feature importance: {FEATURE_IMPORTANCE_OUTPUT_PATH}")
    print(f"[ai-candidate-ranker-v2] predictions: {PREDICTIONS_OUTPUT_PATH}")
    print(f"[ai-candidate-ranker-v2] bucket analysis: {BUCKET_ANALYSIS_OUTPUT_PATH}")
