...
def main() -> None:
    ...
    print(f"[selection-rights] summary json: {SELECTION_SUMMARY_PATH}")
    print(f"[selection-rights] window csv: {WINDOW_SUMMARY_CSV_PATH}")
    print(f"[selection-rights] day csv: {DAY_DETAIL_CSV_PATH}")
