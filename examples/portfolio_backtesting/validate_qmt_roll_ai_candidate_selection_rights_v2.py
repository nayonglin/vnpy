...
def main() -> None:
    ...
    print(f"[selection-rights-v2] summary json: {SELECTION_SUMMARY_PATH}")
    print(f"[selection-rights-v2] window csv: {WINDOW_SUMMARY_CSV_PATH}")
    print(f"[selection-rights-v2] day csv: {DAY_DETAIL_CSV_PATH}")
