...
EXPERIMENT_TAG: str = "qmt_roll_selection_pairwise_long015_volref30_corr_crowding_formal"
...
CORR20_06_08_FLOOR35_OVERRIDES: dict[str, Any] = {
    **VOLREF30_OVERRIDES,
...
CORR20_06_08_FLOOR50_OVERRIDES: dict[str, Any] = {
    **VOLREF30_OVERRIDES,
    "enable_same_direction_correlation_gate": True,
    "same_direction_correlation_gate_lookback": 20,
    "same_direction_correlation_gate_start": 0.60,
...
EXPERIMENTS: tuple[dict[str, Any], ...] = (
    {
        ...
        "file_prefix": "qmt_roll_selection_long015_volref30_corr_formal_current",
        "chart_title": "QMT Roll VolRef30 Current Formal",
        "strategy_overrides": VOLREF30_OVERRIDES,
    },
    {
        "experiment_name": "volref30_corr20_06_08_floor35",
        "file_prefix": "qmt_roll_selection_long015_volref30_corr_formal_floor35",
        "chart_title": "QMT Roll VolRef30 Corr20 06 08 Floor35 Formal",
        "strategy_overrides": CORR20_06_08_FLOOR35_OVERRIDES,
    },
    {
        "experiment_name": "volref30_corr20_06_08_floor50",
        "file_prefix": "qmt_roll_selection_long015_volref30_corr_formal_floor50",
        "chart_title": "QMT Roll VolRef30 Corr20 06 08 Floor50 Formal",
        "strategy_overrides": CORR20_06_08_FLOOR50_OVERRIDES,
    },
)
...
def run_experiments() -> pd.DataFrame:
    ...
    for experiment in EXPERIMENTS:
        ...
        print(f"[volref30-corr-crowding-formal] running {experiment_name}")
...
def main() -> None:
    ...
    print(f"[volref30-corr-crowding-formal] summary csv: {SUMMARY_CSV_PATH}")
    print(f"[volref30-corr-crowding-formal] summary json: {SUMMARY_JSON_PATH}")
