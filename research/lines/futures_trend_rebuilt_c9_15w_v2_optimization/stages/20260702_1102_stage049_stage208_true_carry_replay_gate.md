...
- blocking_reasons：`contract_specs_exact:missing_exact_specs:jd.DCE;current_minute_fill_bars:missing_minute_contracts:39`
- 策略变更：`False`
...
| current_minute_fill_bars             | False   |         482 | missing_minute_contracts:39 | minute_file_index=565                             |
