...
> 说明：本记录为 Stage104 v2 中间记录，已被 `20260705_2105_stage104_intraday_stop_minute_path_slippage_audit.md` 的最终 v2 记录覆盖。后续引用请以 21:05 记录为准。

- line_id：`futures_trend_rebuilt_c9_15w_v2_optimization`
- 当前模式：day
- 记录时间：2026-07-05 21:02 CST
...
```json
{
  ...
  "line_id": "futures_trend_rebuilt_c9_15w_v2_optimization",
  "generated_at": "2026-07-05T21:02:56",
