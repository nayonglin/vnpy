...
- 决策：`stage104_intraday_stop_actual_exit_no_material_adverse_slippage_candidate`
- 样本行数：`81`
- 去重物理事件数：`20`
...
- 行级 broad adverse slippage 闸门：`False`
- 去重 broad adverse slippage 闸门：`False`
- 首根命中 bar 开盘穿越金额：`293,211.60`
- 去重物理事件首根命中 bar 开盘穿越金额：`121,693.20`
- 开盘穿越 execution warning：`True`
...
```json
{
  ...
  "line_id": "futures_trend_rebuilt_c9_15w_v2_optimization",
  "generated_at": "2026-07-05T21:05:33",
  ...
  "row_broad_adverse_slippage": false,
  "unique_broad_adverse_slippage": false,
  "adverse_slippage_positive_row_start_count": 13,
  "adverse_slippage_positive_row_symbol_count": 10,
  "adverse_slippage_positive_unique_event_count": 10,
  "adverse_slippage_positive_unique_symbol_count": 10,
  "first_hit_open_adverse_cash_sum": 293211.6,
  "unique_physical_event_first_hit_open_adverse_cash_sum": 121693.2,
  "open_penetration_warning": true,
  "open_penetration_positive_row_start_count": 9,
  "open_penetration_positive_unique_event_count": 5,
  ...
  "order_api_calls": 0,
  "ctp_connected": false,
  "next_step": "不把 actual exit 相对 planned stop 的成交偏移作为主优化方向；若继续执行层，只能围绕开盘穿越做固定代理风险审计，否则转向非日内止损的账户层暴露、趋势衰退或组合相关性。",
...
- 不把 actual exit 相对 planned stop 的成交偏移作为主优化方向；若继续执行层，只能围绕开盘穿越做固定代理风险审计，否则转向非日内止损的账户层暴露、趋势衰退或组合相关性。

## 独立 Agent 复核

- Halley 复核 v1：核心公式和只读边界正确，但指出两项中风险：decision 应同时看去重物理事件，开盘穿越风险应独立为 execution warning，不能泛化成“日内止损无风险”。置信度 `0.82`。
- Pascal 复核 v2：未发现高/中风险；确认 row-level 与 unique physical-event broad gate 均已纳入，`open_penetration_warning=true` 未被提升为 proxy/true engine；结论与数据一致。置信度 `0.92`。
- 本记录已按复核意见固定为 v2：`stage104_intraday_stop_minute_path_slippage_audit_v2_reviewed_unique_gate`。
...
- 运行后：有但需换问题。actual exit 相对 planned stop 未形成 material adverse slippage；开盘穿越只保留为执行代理 warning，不能直接倒推止损参数。

## 输出

- 报告：`/Users/bytedance/Desktop/person/vnpy/research/lines/futures_trend_rebuilt_c9_15w_v2_optimization/outputs/stage104_intraday_stop_minute_path_slippage_audit/rebuilt_c9_v2_stage104_intraday_stop_minute_path_slippage_audit_report_stage104_intraday_stop_minute_path_slippage_audit_v2_reviewed_unique_gate.md`
...
- 退出原因汇总：`/Users/bytedance/Desktop/person/vnpy/research/lines/futures_trend_rebuilt_c9_15w_v2_optimization/outputs/stage104_intraday_stop_minute_path_slippage_audit/rebuilt_c9_v2_stage104_intraday_stop_minute_path_slippage_audit_by_exit_reason_stage104_intraday_stop_minute_path_slippage_audit_v2_reviewed_unique_gate.csv`
- 起点汇总：`/Users/bytedance/Desktop/person/vnpy/research/lines/futures_trend_rebuilt_c9_15w_v2_optimization/outputs/stage104_intraday_stop_minute_path_slippage_audit/rebuilt_c9_v2_stage104_intraday_stop_minute_path_slippage_audit_by_start_stage104_intraday_stop_minute_path_slippage_audit_v2_reviewed_unique_gate.csv`
- 品种汇总：`/Users/bytedance/Desktop/person/vnpy/research/lines/futures_trend_rebuilt_c9_15w_v2_optimization/outputs/stage104_intraday_stop_minute_path_slippage_audit/rebuilt_c9_v2_stage104_intraday_stop_minute_path_slippage_audit_by_symbol_stage104_intraday_stop_minute_path_slippage_audit_v2_reviewed_unique_gate.csv`
- 分钟源审计：`/Users/bytedance/Desktop/person/vnpy/research/lines/futures_trend_rebuilt_c9_15w_v2_optimization/outputs/stage104_intraday_stop_minute_path_slippage_audit/rebuilt_c9_v2_stage104_intraday_stop_minute_path_slippage_audit_minute_source_audit_stage104_intraday_stop_minute_path_slippage_audit_v2_reviewed_unique_gate.csv`
- 输入审计：`/Users/bytedance/Desktop/person/vnpy/research/lines/futures_trend_rebuilt_c9_15w_v2_optimization/outputs/stage104_intraday_stop_minute_path_slippage_audit/rebuilt_c9_v2_stage104_intraday_stop_minute_path_slippage_audit_input_audit_stage104_intraday_stop_minute_path_slippage_audit_v2_reviewed_unique_gate.csv`
