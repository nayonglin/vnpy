...
| `futures_trend_2019_data_extension` | 期货趋势2019数据延展线 | 商品期货趋势/Stage777 50万 AM41+OI0.8+旧AI | Stage777 + 旧正式 AI 老师已升级为官方候选 `official_candidate_stage777_50w_am41_oi08_old_ai_v1`；Monte Carlo 显示它是高收益高回撤候选，不是 Stage372 防守替代；当前实盘默认仍是 Stage372 20万 | Stage793：`10,000` 路径 `block_60/block_120` 验证下，候选2020同期 DD50 概率 `26.32%/22.98%`，Stage372 同期 `8.84%/4.64%`；坏块前置一次候选2018回撤 `-57.48%`、两次 `-78.50%`，决策不直接切 live default | `research/lines/futures_trend_2019_data_extension/` | 只做候选 shadow、独立资金 sleeve、执行治理和 AM41 工程化；不继续扫 OI 倍率、AM 根数、AI topN、训练窗或 horizon |
