...
| `futures_trend_risk_overlay` | 期货趋势风险覆盖层 | 商品期货趋势/78-1风险叠加层 | 独立研究线，不改78-1 alpha | Stage232：balanced_tranche部署分层候选 | `research/lines/futures_trend_risk_overlay/` | 部署规则草案与影子盘资金分层账本 |
