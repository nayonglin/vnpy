...
FAULT_CASES = (
    ...
    FaultCase("legacy_stage372_identity_conflict", "tests.test_stage179_runtime_profile", "Stage179RuntimeProfileTest", "test_legacy_stage372_identity_blocks_even_with_env_and_confirm", "not_started", "production_live_execution_profile_not_current_official", "adapter_not_created", 0, 0),
